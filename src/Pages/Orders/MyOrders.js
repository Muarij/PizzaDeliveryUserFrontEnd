...
export default function MyOrders() {
  ...
  const addImage=(itemId)=>{
    console.log(itemId)
    fetch(`http://localhost:7071/itemImage/getpizzathumbnail/${mapDetail}`)
      ...
      return  <img src={imageUrl} alt="" style={{ marginLeft: "10px", borderRadius: "20px", width: "150px", height: "150px" }} /> 
      // return  imageUrl 
