...
export default function Itemsize() {
    ...
    const getItemSize = () => {
        ...
        const url = `http://localhost:7071/itemSize/${itemid}/${itemsize}`
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:7071/itemImage/getpizzathumbnail/${itemId}`) ///${itemId}  
                            ...
                            <div>
                                ...
                                <div>
                                    <div className="row">
                                        <div className="col">
                                            <center>
                                                <motion.img src={imageUrl} alt="itemImage" className='shadow img-thumbnail' style={{ height: "380px", width: "480px", borderRadius: "10px", minWidth: "350px",marginBottom:"2%" }}
                                        ...
                                        <div className="col">
                                            ...
                                            <div className="form" id=''>
                                                <div className="row">
                                                    <div className="col">
                                                        <select name="sizeChange" onChange={sizeHandler} id="sizeChange" style={{ width: "200px" }}>
