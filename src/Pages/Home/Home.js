                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                      <a className="nav-link active" aria-current="page" onClick={() => (navigate('/item'))} id='headerBtn'>Pizzas</a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" onClick={() => (navigate('/aboutUs'))} id='headerBtn'>About Us</a>
                    </li>
                    <li>
        ...
        <div className='flatter'>
          <div className="row">
            <div className="col">
              ...
              <div className='' >
                <h1 className='text1'>Feeling hungry </h1>
                <h1 className='text1'>Order Pizza's</h1><br />
                <center>
